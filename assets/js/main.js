...
function buildMobileShell() {
    ...
    const navItems = [
        ...
        { key: "opinions", href: "opinions.html", icon: "fa-regular fa-comments", label: "الآراء" },
...
const translations = {
    ar: {
        ...
        "opinions.eyebrow": "آراؤكم تهمنا",
        "opinions.title": "شارِك رأيك وادعم مدرستك",
        "opinions.lead": "اكتب ملاحظاتك أو اقتراحاتك، وسيطلع عليها فريق المدرسة. يمكنك أيضاً حذف التعليقات المسيئة إن كنت مشرفاً.",
        "opinions.form.eyebrow": "نموذج المشاركة",
        "opinions.form.title": "أرسل رأيك",
        "opinions.form.placeholder": "اكتب رأيك هنا...",
        "opinions.form.submit": "إرسال",
        "opinions.list.eyebrow": "أحدث الآراء",
        "opinions.list.title": "مشاركات المستخدمين",
    ...
    en: {
        ...
        "opinions.eyebrow": "Your voice matters",
        "opinions.title": "Share your opinion",
        "opinions.lead": "Leave feedback or suggestions; staff can review and moderate abusive comments.",
        "opinions.form.eyebrow": "Feedback form",
        "opinions.form.title": "Send your opinion",
        "opinions.form.placeholder": "Write your feedback here...",
        "opinions.form.submit": "Send",
        "opinions.list.eyebrow": "Latest feedback",
        "opinions.list.title": "User submissions",
